...
public class OEUtility {
	...
	public static String displayCurrency(BigDecimal value, Locale locale) {
	...
	public static BigDecimal currencyToBigDecimal(String ammount, Locale locale) throws ParseException {
		

		 DecimalFormat nf = (DecimalFormat)NumberFormat.getInstance(locale);
	      nf.setParseBigDecimal(true);

	      BigDecimal bd = (BigDecimal)nf.parse(ammount, new ParsePosition(0));
		return bd;
	}
