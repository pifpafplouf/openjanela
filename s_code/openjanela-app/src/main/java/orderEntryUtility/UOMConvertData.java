...
public class UOMConvertData
{
	
	public UOMConvertData()
	{
	}
	
	public UOMConvertData(String entryUOM)
	{
		entryUOM = entryUOM;
	}
	...
	public static void setCurrentMOU(int mou)
	{
		selectUOM = mou;
	}
	...
	private static String[] seperatingDecimal(String stringForSeparating)
				throws Exception
				{
	...
	private static boolean containOneSpace(char charForCheck[])
	{
		...
		if(numberOfSpaceBeforeSlash == 0 && numberOfSpaceAfterSlash == 0)
			...
			if(numberOfSpaceBeforeSlash == 1 && numberOfSpaceAfterSlash == 0)
				type = true;
			else
				if(numberOfSpaceBeforeSlash == 0 && numberOfSpaceAfterSlash > 0)
					type = false;
	...
	private static String decimalToFraction(double decimalNumber)
	{
		...
		if(decimalNumber >= 0.015625D)
		{
			...
			if(decimalNumber % 0.015625D < 0.0078125D)
			{
				i = 1;
				numeratorPart.append(i);
			}
	...
	static final double OneOver64 = 0.015625D;
	static final double OneOver32 = 0.03125D;
	static final double OneOver16 = 0.0625D;
	static final double OneOver8 = 0.125D;
	static final double OneOver4 = 0.25D;
	static final double OneOver2 = 0.5D;
