...
public class CalculateMullion
{
	...
	public CalculateMullion(final AddMullionV parent)
		{
	...
	public Profiles calculateCoord(Profiles myMullion)
	{
...
//			}
		...
		final double hypCenter)
	{
		...
		addMullionV.newStartingYRTc = myMullion.y2a = myMullion.y2a3 =
			addMullionV
			.intersectY(
					//
					myMullion.x2cl, //
			...
			myMullion.y2cl = myMullion.y2a3 = myMullion.y2a =
				arcX
				.getYusingX(
						myMullion.x2cl,
						myMullion.y2cl,
		...
		if(myMullion.limitStartY1a.partForm==1) {
			addMullionV.newStartingYLBa =myMullion.y1a = myMullion.y1a3 =
				addMullionV
				.intersectY(
						//
						myMullion.x1al, //
			...
			myMullion.y1al = myMullion.y1a3 = myMullion.y1a =
				arcX
				.getYusingX(
						myMullion.x1al,
						myMullion.y1al,
		...
		addMullionV.newStartingYCenter = myMullion.ycs =
			...
			.intersectY(
					...
					myMullion.limitStartYC.startYBA-hypCenter, //
					myMullion.limitStartYC.endXBA, //
					myMullion.limitStartYC.endYBA-hypCenter//
			);
			...
			myMullion.y1al = myMullion.y1a3 = myMullion.y1a =
				...
				.getYusingX(
						...
						myMullion.centerXs,
						newYBotCenter,
						myMullion.limitStartYC.radius1BA - -hypCenter,
	...
	public void doStartEndType2P(final Profiles myMullion)
	{
		...
		if(myMullion.limitStartY2c.partForm==1) {
			addMullionV.newStartingYRTc =  myMullion.y2a3 = myMullion.y2a =
				addMullionV
				.intersectY(
						myMullion.x2cl, //
						addMullionV.newStartingYRTc, //
			...
			addMullionV.newStartingYRTc =  myMullion.y2cl = myMullion.y2a3 = myMullion.y2a =
				arcX
				.getYusingX(
						myMullion.x2cl,
						myMullion.y2cl,
	...
	public void doStartEndType3P(final Profiles myMullion)
	{
		...
		if(myMullion.limitStartY2c.partForm==1) {
		addMullionV.newStartingYRTc = myMullion.y2a = myMullion.y2cl =
			addMullionV
			.intersectY(
					myMullion.x2cl, //
					addMullionV.newStartingYRTc, //
		...
		if(myMullion.limitStartY1a.partForm==1) {
			addMullionV.newStartingYLBa =  myMullion.y1a = myMullion.y1al =
				addMullionV
				.intersectY(
						//
						myMullion.x1al, //
		...
		if(myMullion.limitStartY2.partForm==1) {
			addMullionV.newStartingYRT = myMullion.y2 =
				addMullionV
				.intersectY(
						myMullion.x2,
						addMullionV.newStartingYRT,
		...
		if(myMullion.limitStartY1.partForm==1) {
			addMullionV.newStartingYLB = myMullion.y1 =
				addMullionV
				.intersectY(
						//
						myMullion.x1, //
		...
		final double hypCenter)
	{
		...
		addMullionV.newStartingYCenter = myMullion.ycs =
			...
			.intersectY(
					...
					myMullion.centerXs, //
					newYBotCenter, //
					myMullion.limitStartY2c.xcs, //
					myMullion.limitStartY2c.ycs-hypCenter, //
					myMullion.limitStartY2c.xce, //
					myMullion.limitStartY2c.yce-hypCenter//
			);
		}if(myMullion.limitStartYC.partForm==2) {
			myMullion.y1al = myMullion.y1a3 = myMullion.y1a =
				arcX
				.getYusingX(
						...
						myMullion.centerXs,
						newYBotCenter,
						myMullion.limitStartYC.radiusXYCenter - -hypCenter,
						myMullion.limitStartYC.x1,
						myMullion.limitStartYC.y1,
						false);
		}if(myMullion.limitStartYC.partForm==3) {
...
//		}
	...
	public Profiles calculateCoordinArchIIT(
			final Profiles myMullion)
		{
			...
			if (myMullion.endTypeLT == 3)
				{
					...
					myMullion.y1a3 = arcX.getYusingX(
							myMullion.x1al,
							myMullion.y1al,
							myMullion.x4al,
							myMullion.y4al,
			...
			if (myMullion.endTypeLT == 1)
				{
					...
					myMullion.centerYs = myMullion.ycs =
						arcX
						.getYusingX(
								myMullion.centerXs,
								myMullion.centerYs,
					...
					myMullion.y1al = myMullion.y1a = myMullion.y1a3 =
						arcX
						.getYusingX(
								myMullion.x1al,
								myMullion.y1al,
	...
	public Profiles calculateCoordinArchIIB(
			final Profiles myMullion)
		{
			...
			if (myMullion.endTypeLT == 2)
				{
					...
					myMullion.centerYe = myMullion.yce =
						arcX
						.getYusingX(
								myMullion.centerXs,
								myMullion.centerYs,
					...
					myMullion.y4al = myMullion.y4a3 = myMullion.y4a =
						arcX
						.getYusingX(
								myMullion.x1al,
								myMullion.y1al,
					...
					myMullion.y3cl = myMullion.y3a3 = myMullion.y3a =
						arcX
						.getYusingX(
								myMullion.x2cl,
								myMullion.y2cl,
	...
	public Profiles getCCoordinatesForEllipse(
			final Profiles myMullion)
		{
			...
			final double myX2 =
				myX1 + myMullion.thickness;
			final double myXC =
				myX1 + myMullion.thickness / 2;
			...
			xCoordBoc =
				addMullionV.xCoordBc.toArray();
			yCoordBoc =
				addMullionV.yCoordBc.toArray();
			double myY1 = 0;
			double myY2 = 0;
			double myYC = 0;
...
//					}
	...
	public void doEndEndType1(
			...
			final double hypCenter)
		{
			if(myMullion.limitEndY3c.cOrM==0){
		...
		final double hypCenter)
	{
		...
		if(myMullion.limitEndY3c.partForm==1) {
			newYBotRTc = myMullion.y3a3 = myMullion.y3a = myMullion.y3cl=
		...
		if(myMullion.limitEndY4a.partForm==1) {
			newYBotLBa = myMullion.y4a3 = myMullion.y4a = myMullion.y4al=
				addMullionV.intersectY(
		...
		if(myMullion.limitEndYC.partForm==1) {
			newYBotCenter = myMullion.yce= myMullion.centerYe=
				addMullionV.intersectY(
						...
						myMullion.limitEndYC.startYBA+ hypCenter,
						myMullion.limitEndYC.endXBA,
						myMullion.limitEndYC.endYBA+ hypCenter );
		}
		if(myMullion.limitEndYC.partForm>=2) {
			newYBotCenter = myMullion.yce= myMullion.centerYe=
				arcX.getYusingX(
						...
						myMullion.centerXe,
						newYBotCenter,
					myMullion.limitEndYC.radius1BA + hypCenter,
		...
		newYBotRT = myMullion.y3b = myMullion.y3=
			addMullionV
			.intersectY(
					myMullion.x3cl,
					myMullion.y3cl,
	...
	public void doEndEndType2P(final Profiles myMullion)
	{
		...
		if(myMullion.limitEndY3c.partForm==1) {
			newYBotRTc = myMullion.y3a = myMullion.y3a3 = myMullion.y3cl =
				addMullionV
				.intersectY(
						myMullion.x3cl,
						addMullionV.newStartingYRTc,
	...
	public void doEndEndType3P(final Profiles myMullion)
	{
		...
		if(myMullion.limitEndY3c.partForm==1) {
		newYBotRTc = myMullion.y3a = myMullion.y3cl=
			addMullionV
			.intersectY(
					myMullion.x3cl,
					addMullionV.newStartingYRTc,
		...
		}else if(myMullion.limitEndY3c.partForm>=2) {
			newYBotRTc = myMullion.y3a = myMullion.y3cl=
				arcX
				.getYusingX(
						myMullion.x3cl,
		...
		myMullion.y3b =
		...
		}else if(myMullion.limitEndY3.partForm>=2) {
			newYBotRT =  myMullion.y3=
				arcX
				.getYusingX(
						myMullion.x3,
		 ...
		 if(myMullion.limitEndY4a.partForm==1) {
			newYBotLBa = myMullion.y4a =  myMullion.y4al=
				addMullionV
				.intersectY(
						//
						myMullion.x4al, //
		 ...
		 }else if(myMullion.limitEndY4a.partForm>=2) {
			 newYBotLBa = myMullion.y4a =  myMullion.y4al=
					arcX
					.getYusingX(
							myMullion.x4al, //
		 ...
		 if(myMullion.limitEndY4.partForm==1) {
			 ...
			 }else if(myMullion.limitEndY4.partForm>=2) {
				 newYBotLB = myMullion.y4 =
						arcX
						.getYusingX(
								myMullion.x4, //
								addMullionV.newStartingYLB, //
		 ...
		 if(myMullion.limitEndYC.partForm==1) {
			 newYBotCenter = myMullion.centerYe =
					addMullionV
					.intersectY(
							myMullion.centerXe,
							addMullionV.newStartingYCenter,
		...
		if(myMullion.limitEndYC.partForm==1) {
			newYBotCenter = myMullion.yce= myMullion.centerYe=
				addMullionV.intersectY(
						...
						myMullion.centerXe, //
						newYBotCenter, //
						myMullion.limitEndYC.centerXs,
						myMullion.limitEndYC.centerYs+ hypCenter,
						myMullion.limitEndYC.centerXe,
						myMullion.limitEndYC.centerYe+ hypCenter );
		}
		if(myMullion.limitEndYC.partForm>=2) {
			newYBotCenter = myMullion.yce= myMullion.centerYe=
				arcX.getYusingX(
						...
						myMullion.centerXe,
						newYBotCenter,
					myMullion.limitEndYC.radiusXYCenter + hypCenter,
					myMullion.limitEndYC.x1,
					myMullion.limitEndYC.y1,
					true);
		}
