...
public class TextFieldTop {
    ...
    public int sizeM = 0; // size in

    public int sizeCM = 0;

    public int sizeI = 0; // size in
    ...
    public int newSizeM = 0;

    public int newSizeCM = 0;

    public int newSizeI = 0;

    public int newSizeCI = 0;
