 ...
 *          Time: 09:35 AM
 */
public class ContactsPersistenceEAO extends GenericPersistenceEAO<Contacts, ContactsPK> implements ContactsEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(ContactsPersistenceEAO.class);
    ...
    public Contacts findRemoteDefaultContact(Integer supplierId, Integer partnerId) throws GenericPersistenceEAOException {
        ...
        try {
            ...
            Contacts contacts = (Contacts)em.createQuery("select c from Contacts c where c.defaultContact = true and " +
                    "c.partnerId = :partnerId").setParameter("partnerId", partnerId).getSingleResult();
