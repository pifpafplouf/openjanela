 ...
 *          Time: 10:00 AM
 */
public class PricingGroupPersistenceEAO extends GenericPersistenceEAO<PricingGroup, Integer> implements PricingGroupEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(PricingGroupPersistenceEAO.class);

    //Entity Access Object
    private PartnersEAO partnersEAO;

    /**
     * Pricing Group Persistence Default Constructor
     */
    public PricingGroupPersistenceEAO() {
    ...
    public List<PricingGroup> findAllRemote(int supplierId) throws GenericPersistenceEAOException {
        try {
            ...
            return em.createQuery("select p from PricingGroup p order by p.id").getResultList();
