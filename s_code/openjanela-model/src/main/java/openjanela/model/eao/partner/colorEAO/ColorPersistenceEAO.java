 ...
 *          Time: 1:27 PM
 */
public class ColorPersistenceEAO extends GenericPersistenceEAO<Color, Integer> implements ColorEAO{

    //Apache log4j
    private static final Logger logger = Logger.getLogger(ColorPersistenceEAO.class);
    ...
    public List<Color> findAllRemote(int supplierId) throws GenericPersistenceEAOException {
        ...
        try {
            ...
            return em.createQuery("select c from Color c order by c.id").getResultList();
