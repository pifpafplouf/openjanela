 ...
 *          Time: 10:49 AM
 */
public class PartsLabelPosPersistenceEAO extends GenericPersistenceEAO<PartsLabelPos, Integer> implements PartsLabelPosEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(PartsLabelPosPersistenceEAO.class);

    //Entity Access Object
    private PartnersEAO partnersEAO;

    /**
     * Parts Label Position Constructor
     */
    public PartsLabelPosPersistenceEAO() {
    ...
    public List<PartsLabelPos> findAllRemote(int supplierId) throws GenericPersistenceEAOException {
        try {
            ...
            return em.createQuery("select p from PartsLabelPos p").getResultList();
