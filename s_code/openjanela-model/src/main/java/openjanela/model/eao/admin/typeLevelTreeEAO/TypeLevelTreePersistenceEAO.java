 ...
 *         Time: 09:32 AM
 */
public class TypeLevelTreePersistenceEAO extends GenericPersistenceEAO<TypeLevelTree, Integer> implements TypeLevelTreeEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(TypeLevelTreePersistenceEAO.class);
    ...
    @Override
    public List<TypeLevelTree> findByLevelTypes(int pid) throws GenericPersistenceEAOException {
        ...
        try {
            ...
            // Query string
            Query query = em.createQuery("select t from TypeLevelTree t where t.id.levelId = :pid");
            query.setParameter("pid", pid);

            List<TypeLevelTree> rules = query.getResultList();
