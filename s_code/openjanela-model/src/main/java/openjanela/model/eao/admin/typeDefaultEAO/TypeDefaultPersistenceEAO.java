package openjanela.model.eao.admin.typeDefaultEAO;
...
import openjanela.model.entities.admin.TypeDefault;
 ...
 *          Time: 09:39 PM
 */
public class TypeDefaultPersistenceEAO extends GenericPersistenceEAO<TypeDefault, Integer> implements TypeDefaultEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(TypeDefaultPersistenceEAO.class);
