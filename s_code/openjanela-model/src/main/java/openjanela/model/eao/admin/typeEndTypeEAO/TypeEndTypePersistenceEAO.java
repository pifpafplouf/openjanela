package openjanela.model.eao.admin.typeEndTypeEAO;
 ...
 *          Time: 03:01 PM
 */
public class TypeEndTypePersistenceEAO extends GenericPersistenceEAO<TypeEndType, Integer> implements TypeEndTypeEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(TypeEndTypePersistenceEAO.class);
    ...
    @Override
    public List<TypeEndType> findAll() throws GenericPersistenceEAOException {
        ...
        try {
            ...
            List<TypeEndType> typeLevels = em.createQuery("select t from TypeEndType t order by t.id").getResultList();
