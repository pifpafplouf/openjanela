 ...
 *          Time: 10:28 PM
 */
public class PartsCostPricePersistenceEAO extends GenericPersistenceEAO<PartsCostPrice, Integer> implements PartsCostPriceEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(PartsCostPricePersistenceEAO.class);

    //Entity Access Object
    private PartnersEAO partnersEAO;

    /**
     * Parts Cost Price Persistence Constructor
     */
    public PartsCostPricePersistenceEAO() {
    ...
    public List<PartsCostPrice> findAllRemote(int supplierId) throws GenericPersistenceEAOException {
        try {
            ...
            return em.createQuery("select p from PartsCostPrice p").getResultList();
