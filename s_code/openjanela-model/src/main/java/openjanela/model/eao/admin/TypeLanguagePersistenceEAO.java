...
import openjanela.model.entities.admin.TypeLanguage;
 ...
 *          Time: 07:23 PM
 */
public class TypeLanguagePersistenceEAO extends GenericPersistenceEAO<TypeLanguage, String> implements TypeLanguageEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(TypeLanguagePersistenceEAO.class);
