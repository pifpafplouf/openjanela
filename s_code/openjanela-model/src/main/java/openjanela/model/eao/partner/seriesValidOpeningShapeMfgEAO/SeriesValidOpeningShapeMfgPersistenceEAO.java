 ...
 *          Time: 10:27 AM
 */
public class SeriesValidOpeningShapeMfgPersistenceEAO extends GenericPersistenceEAO<SeriesValidOpeningShapeMfg, SeriesValidOpeningShapeMfgPK>
        implements SeriesValidOpeningShapeMfgEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(SeriesValidOpeningShapeMfgPersistenceEAO.class);

    //Entity Access Object
    private PartnersEAO partnersEAO;

    /**
     * Series Valid Opening Shape Default Constructor
     */
    public SeriesValidOpeningShapeMfgPersistenceEAO() {
    ...
    @Override
    public List<SeriesValidOpeningShapeMfg> findBySeriesId(int seriesId) throws GenericPersistenceEAOException {
        ...
        try {
            ...
            String query = "select svos from SeriesValidOpeningShapeMfg svos where svos.id.seriesId = :seriesId";

            //Executing query and retrieve collection
            List<SeriesValidOpeningShapeMfg> validShapes = em.createQuery(query).setParameter("seriesId", seriesId).getResultList();
