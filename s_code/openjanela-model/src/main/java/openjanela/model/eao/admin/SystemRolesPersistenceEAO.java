...
import openjanela.model.entities.admin.SystemRoles;
 ...
 *          Time: 07:38 PM
 */
public class SystemRolesPersistenceEAO extends GenericPersistenceEAO<SystemRoles, Integer> implements SystemRolesEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(SystemRolesPersistenceEAO.class);
