package openjanela.model.eao.admin.systemMeasurementEAO;
...
import openjanela.model.entities.admin.SystemMeasurement;
 ...
 *          Time: 02:04 PM
 */
public class SystemMeasurementPersistenceEAO extends GenericPersistenceEAO<SystemMeasurement, Integer> implements
        SystemMeasurementEAO {

    //Apache log4j
    private static final Logger logger = Logger.getLogger(SystemMeasurementPersistenceEAO.class);
